...
export default class SetMea extends Component {
      ...
      <View className="setMeal" >
        <View className="coupon_box">
          <View className="coupon_box_img">
            <img src="http://n.sinaimg.cn/news/transform/700/w1000h500/20190718/b210-hzxsvnp4185401.jpg" />
          </View>
          <View className="coupon_box_msg">
            <View className="coupon_box_msg_title">xxxxxs试用套装
        ...
        <View className="setMeal_rule">
          ...
          <View className="setMeal_rule_list_box">
            <View className="setMeal_rule_list">mmmmmm</View>
            <View className="setMeal_rule_list">mmmmmm</View>
            <View className="setMeal_rule_list">mmmmmm</View>
          </View>
        </View>
        ...
        <View className="setMeal_brief">
          ...
          <View className="setMeal_brief_list_box">
            <View className="setMeal_brief_list">
              <img src="http://n.sinaimg.cn/news/transform/700/w1000h500/20190718/b210-hzxsvnp4185401.jpg" />
            </View>
            <View className="setMeal_brief_list">
              <img src="http://n.sinaimg.cn/news/transform/700/w1000h500/20190718/b210-hzxsvnp4185401.jpg" />
