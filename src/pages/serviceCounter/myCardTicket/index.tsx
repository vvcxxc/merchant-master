    ...
    render() {
        return (
            <div>
                ...
                {/* modal */}
                <QRModal isShow={this.state.flag} order={123456789123} onClose={() => {console.log('关闭')}} name="Cake" url="https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1568696416768&di=9e5ff1e0f68590e6e1f0530b29f0e42a&imgtype=0&src=http%3A%2F%2Fimgs.focus.cn%2Fupload%2Fcs%2F11091%2Fb_110904724.jpg"/>
            </div>
        )
    }
}   